// MsgTestDlg.cpp : implementation file
//
...
CMsgTestDlg::CMsgTestDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMsgTestDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMsgTestDlg)
...
BEGIN_MESSAGE_MAP(CMsgTestDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON3, OnEditWnd)
	ON_BN_CLICKED(IDC_BUTTON4, OnGetWnd)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMsgTestDlg message handlers
...
void CMsgTestDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMsgTestDlg::OnEditWnd() 
{
	...
	char *pCaption_Text = "消息测试";
	::SendMessage(hWnd,WM_SETTEXT,(WPARAM)0,(LPARAM)pCaption_Text);
